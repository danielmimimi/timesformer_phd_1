...
texts = ["Original_HLSU_data_half_step","Original_HLSU_data_full_step","Original_HLSU_data_uniform"]
frame_distances = ["half_step","one_step","uniform"]
video_path = Path('/workspaces/TimeSFormer/timesformer/datasets/hslu/gen2r')
configs = [
    '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8_224_gen2r_half_step.yaml',
    '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8_224_gen2r_one_step.yaml',

...
model_files = [
'/workspaces/TimeSFormer/checkpoints/checkpoint_6_blocks_frozen_val_0.0_epoch_00021.pyth',
'/workspaces/TimeSFormer/checkpoints/checkpoint_9_blocks_frozen_val_0.0_epoch_00045.pyth',
'/workspaces/TimeSFormer/checkpoints/checkpoint_10_blocks_frozen_val_0.0_epoch_00069.pyth',
...
texts = ["SPREAD_HS_F6_HS",
        ...
        "MP_HS_F6_R",
         "MP_HS_F9_R",
         "MP_HS_F10_R"]
frame_distances = ["SPREAD_HS_F6_HS",
        "SPREAD_HS_F9_HS",
         "SPREAD_HS_F10_HS",
...
configs = [
    ...
    '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8_224_spread_half_step.yaml',
    '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8_224_spread_half_step.yaml',
    # '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8_224_gen2_half_step_freezed_09.yaml',
    # '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8_224_gen2_half_step_freezed.yaml',

    '/workspaces/TimeSFormer/configs/hslu/TimeSformer_divST_8x32_224_k600_half_step.yaml',
...
output_dir = Path('/workspaces/TimeSFormer/freezed')
